...
import Max10 from '../../image/Saly-15.png';
    ...
    <>
        ...
        <div className='p-20  max-sm:flex-col max-lg:flex-col-reverse flex justify-center flex-col items-center'>
            ...
            <div className='flex  max-sm:flex-col flex-col gap-2'>
                ...
                <h1 className='max-sm:w-[75vw] text-[15px] max-lg:w-[80vw] leading-7 w-[40vw]' ><span className='font-bold'> • Graphic Design:</span> Delivering captivating visual assets and branding that resonate with 
                your audience and amplify your market presence.</h1>
                <h1 className='max-sm:w-[75vw] text-[15px] max-lg:w-[80vw] leading-7 w-[40vw]'><span className='font-bold'>• Web Development: </span> Creating responsive, intuitive, and scalable websites that form a 
                strong digital foundation for your business.</h1>
                <h1 className='max-sm:w-[75vw] text-[15px] max-lg:w-[80vw] leading-7 w-[40vw]'><span className='font-bold'>• Cloud Solutions: </span> Implementing secure and flexible cloud infrastructure that streamlines 
                operations, reduces cost, and ensures seamless business continuity. </h1>
                <h1 className='max-sm:w-[75vw] text-[15px] max-lg:w-[80vw] leading-7 w-[40vw]'><span className='font-bold'>• Digital Marketing: </span>   Crafting data-driven strategies to enhance your visibility, engage 
                your audience, and turn leads into loyal customers. </h1>
                <h1 className='max-sm:w-[75vw] text-[15px] max-lg:w-[80vw] leading-7 w-[40vw]'><span className='font-bold'>• Information Technology Training:</span>  Equipping individuals and teams with practical, 
                up-to-date technical skills to stay ahead in today&apos;s dynamic digital landscape.</h1>
            ...
            <div className='max-sm:flex-col '>
                <div className='flex gap-5 max-sm:flex-col  items-center'>
                    <div className='flex flex-col gap-2'>
                        <h1 className='max-sm:w-[75vw] font-bold text-[35px] max-lg:w-[80vw]  '>Our Aim</h1>
                        <h1 className='max-sm:w-[75vw] text-[15px] max-lg:w-[80vw] leading-7  w-[40vw]'>At 1691 Tech Solutions, our aim is to empower businesses and individuals by delivering 
                        ...
                        long-term success through customer-focused strategies and expert-driven services.</h1>
                    </div>
                    <div>
                        <Image
